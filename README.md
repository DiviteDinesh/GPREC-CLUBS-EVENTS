...
- Students: View club details, explore event listings, and interact with the AI bot. (in progess)
...
```
git clone https://github.com/DiviteDinesh/college-clubs-events.git
...
Developed by [Divite Dinesh](https://github.com/DiviteDinesh).
